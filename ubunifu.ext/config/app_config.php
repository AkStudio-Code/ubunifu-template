...
$config = [
    ...
    'controller' => 'Account',
    'action'=>'index',
    'login_controller' =>'account',
    'login_view' => 'sign-in',
    'app_dir' =>  realpath(dirname(__FILE__) . '/../../') . '/apps/',
    'public_dir'=> realpath(dirname(__FILE__) . '/../../') . '/ubunifu.ext/',
    ...
    'site_url' =>'http://' . $_SERVER['HTTP_HOST'] . str_replace('ubunifu.ext/public', '', dirname($_SERVER['SCRIPT_NAME'])),
    'pretty_url' => true,
