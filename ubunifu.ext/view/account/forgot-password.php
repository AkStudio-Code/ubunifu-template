...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="120x120" href="<?=$this->url()?>/assets/img/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?=$this->url()?>/assets/img/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?=$this->url()?>/assets/img/favicon/favicon-16x16.png">
    <link rel="manifest" href="<?=$this->url()?>/assets/img/favicon/site.webmanifest">
    <link rel="mask-icon" href="<?=$this->url()?>/assets/img/favicon/safari-pinned-tab.svg" color="#ffffff">
    ...
    <section class="vh-lg-100 mt-4 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <div class="row justify-content-center form-bg-image">
                <p class="text-center"><a href="<?= $this ->link?>demo/account/sign-in" class="text-gray-700"><i class="fas fa-angle-left mr-2"></i> Back to log in</a></p>
